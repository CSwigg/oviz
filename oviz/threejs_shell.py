THREEJS_SHELL_HTML = """
      ...
      <div class="oviz-three-sky-aperture" data-open="false" data-promoting="false" aria-hidden="true">
        <div class="oviz-three-sky-aperture-frame-clip">
          <iframe class="oviz-three-sky-aperture-frame oviz-three-sky-aperture-frame-a" loading="eager" referrerpolicy="no-referrer" tabindex="-1"></iframe>
        </div>
        <div class="oviz-three-sky-aperture-frame-clip">
          <iframe class="oviz-three-sky-aperture-frame oviz-three-sky-aperture-frame-b" loading="eager" referrerpolicy="no-referrer" tabindex="-1"></iframe>
        </div>
