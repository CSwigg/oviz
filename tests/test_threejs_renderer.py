...
class ThreeJSRendererTests(unittest.TestCase):
    ...
    def test_threejs_renderer_exports_mobile_mode_metadata_and_ui_hooks(self):
        ...
        self.assertIn("oviz-three-mobile-ar", html)
        self.assertIn('class="oviz-three-mobile-ar" type="button" title="Open AR export options"', html)
        self.assertNotIn('class="oviz-three-mobile-ar" type="button" title="Open AR export options" aria-haspopup="dialog" aria-expanded="false" data-has-selection="false" disabled', html)
        ...
        self.assertIn("const enabled = !minimalModeEnabled && !ovizArExportBusy;", html)
        ...
        self.assertNotIn("OVIZ_AR_MAX_LABELS", html)
        self.assertNotIn("ovizArCollectOrbitTrails", html)
        self.assertNotIn("ovizArCreateLabelTexture", html)
        self.assertIn("function ovizArCreateVolumeCloudTexture", html)
        self.assertIn("function ovizArAppendCloudletGeometry", html)
        self.assertIn('volumeRepresentation: "soft-gaussian-cloudlets"', html)
