...
class ThreeJSRendererTests(unittest.TestCase):
    ...
    def test_threejs_renderer_can_use_live_aladin_sky_dome_background(self):
        ...
        self.assertIn("markSkyDomeBackgroundViewApplied(data.seq, data)", html)
        ...
        self.assertIn("rotationDeg,", html)
        ...
        self.assertIn('const setFov = aladinCallable("setFov");', html)
        self.assertIn('const setFoV = aladinCallable("setFoV");', html)
        self.assertIn("setAladinFovDeg(skyDomeBackgroundOnly ? 90.0 : 360.0);", html)
        self.assertIn('const setRotation = aladinCallable("setRotation");', html)
        self.assertIn("rotationMethod = setAladinRotationDeg(rotationDeg);", html)
        self.assertIn("appliedFovDeg: appliedView.appliedFovDeg", html)
        self.assertIn("appliedRotationDeg: appliedView.appliedRotationDeg", html)
    ...
    def test_threejs_renderer_exposes_opt_in_sky_debug_instrumentation(self):
        ...
        self.assertIn("lastAppliedFovDeg", html)
        self.assertIn("lastAppliedRotationDeg", html)
        self.assertIn("lastFovMethod", html)
