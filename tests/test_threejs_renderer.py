...
class ThreeJSRendererTests(unittest.TestCase):
    ...
    def test_threejs_renderer_exposes_sky_aperture_for_live_aladin_backgrounds(self):
        ...
        self.assertIn("oviz-three-sky-aperture-frame-preset", html)
        ...
        self.assertIn("skyAperturePresetOptions.forEach((_, index) => createSkyAperturePresetFrame(index));", html)
        self.assertIn("skyAperturePresetFrameReady", html)
