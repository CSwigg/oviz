...
class ThreeJSRendererTests(unittest.TestCase):
    ...
    def test_make_plot_can_return_threejs_html_wrapper(self):
        ...
        self.assertIn("Decrease or increase every point trace size", html)
        self.assertIn("Toggle the Galactic grid.", html)
        self.assertIn("Capture a new State without opening the States menu.", html)
        self.assertIn('if (lowerKey === "n")', html)
        self.assertIn("ovizQuickAddState();", html)
        self.assertIn('if (lowerKey === "g")', html)
        self.assertIn('if (key === "[" || key === "]")', html)
        self.assertIn("function setGlobalPointSizeScale(value, options = {})", html)
        self.assertIn("function ovizScaleRenderedPointSizes(ratio, requestedTraceKey", html)
        self.assertIn("function ovizScheduleRenderedPointSizeScale(ratio, traceKey", html)
        self.assertIn("function ovizCancelPendingRenderedPointSizeScales()", html)
        self.assertIn("root.dataset.pointSizeLiveUpdates", html)
        self.assertIn("state.hasPoints && !state.hasLabels && !state.hasVectors", html)
        self.assertIn("sizePointsByStarsEnabled = true;", html)
        self.assertIn(':not([data-mobile="true"]) .oviz-three-legend-panel', html)
        self.assertIn("font-size: 16.15px !important;", html)
        self.assertIn("font-size: 18.08px !important;", html)
        self.assertIn("font-size: 12.69px !important;", html)
        self.assertIn(':not([data-mobile="true"]) .oviz-three-legend-name', html)
        self.assertIn("white-space: nowrap !important;", html)
        self.assertIn(':not([data-mobile="true"]) .oviz-three-mobile-more', html)
        self.assertIn("display: none !important;", html)
        self.assertIn("grid-template-columns: 16px minmax(0, 1fr) !important;", html)
        self.assertIn("min-height: 22px !important;", html)
        self.assertIn(':not([data-mobile="true"]) .oviz-three-search-toggle svg', html)
        self.assertIn('[data-zen="true"] .oviz-three-footer', html)
        ...
        self.assertIn("function scheduleLegendPanelRestoreAfterOverlayMode()", html)
        self.assertIn("{ allowAutoCap: false }", html)
        self.assertIn('root.dataset.presentationMode === "true"', html)
        self.assertIn('root.dataset.zen === "true"', html)
        self.assertIn("let skyControlsDrawerOpenBeforeZen = null;", html)
        self.assertIn("const restoreSkyControlsDrawer = Boolean(", html)
        self.assertIn("skyControlsDrawerOpenBeforeZen", html)
        self.assertIn("setSkyControlsDrawerOpen(true);", html)
        self.assertIn("1.0 / memberSizeDenominator,\n          0.00001,", html)
        self.assertIn(
        ...
        self.assertIn("ovizDeckIsPresenting()", html)
        self.assertIn("function ovizNavigatePresentation(direction)", html)
        self.assertIn("ovizStatesPresentationPrevious()", html)
        self.assertIn("ovizStatesPresentationNext()", html)
        self.assertIn("ovizNavigatePresentation(-1)", html)
        self.assertIn("ovizNavigatePresentation(1)", html)
        ...
        self.assertIn("oviz-three-deck-editor", html)
        self.assertIn(">Slides ▸</button>", html)
        self.assertIn(">Text ▸</button>", html)
        self.assertIn("3D Text", html)
        self.assertIn("Move to target", html)
        self.assertIn("function setManualLabelMenuOpen(isOpen)", html)
        self.assertIn("manualLabelShellEl.dataset.open", html)
        self.assertIn("root.dataset.manualLabelCount", html)
        self.assertIn("root.dataset.activeManualLabelStyle", html)
        self.assertIn("textureScale: 6.0", html)
        self.assertIn("screenStable: true", html)
        self.assertIn("...sprite.userData,", html)
        self.assertIn('min="1" max="180" step="0.5"', html)
        self.assertIn("Place in scene", html)
        self.assertIn('class="oviz-three-manual-label-visibility"', html)
        self.assertIn("toggleActiveManualLabelVisibility", html)
        self.assertIn("visible: rawLabel.visible !== false", html)
        self.assertIn("label.visible === false", html)
        self.assertIn("label && label.text && label.visible !== false", html)
        self.assertIn('const hiddenSuffix = label.visible === false ? " (hidden)" : "";', html)
        self.assertIn("manualLabelPlacementArmed", html)
        self.assertIn("placeManualLabelFromCanvasEvent(event)", html)
        self.assertIn("manualLabelXEl", html)
        self.assertIn("const MIN_MANUAL_LABEL_SIZE = 1.0", html)
        self.assertIn("requestedResolutionScale", html)
        self.assertIn("* boost, 16.0", html)
        self.assertIn("color: sanitizeManualLabelColor(label.color", html)
        self.assertIn("new THREE.Sprite(material)", html)
        self.assertIn(".oviz-three-widget-menu > .oviz-three-search-shell", html)
        self.assertIn("order: 100;", html)
        self.assertNotIn(">Edit slides</button>", html)
        self.assertIn("oviz-deck-authoring-layer", html)
        self.assertIn("function initializeOvizDeck()", html)
        self.assertIn('content.addEventListener("pointerdown", (event) => {', html)
        self.assertIn('content.addEventListener("focus", selectContentBlock);', html)
        self.assertIn('ovizDeckButtonEl.textContent = ovizDeckEditorOpen ? "Slides ▾" : "Slides ▸";', html)
        self.assertIn("function ovizDeckUndo()", html)
        self.assertIn("function ovizDeckRedo()", html)
        self.assertIn("ovizDeckHandleHistoryShortcut", html)
        self.assertIn('key === "Backspace" || key === "Delete"', html)
        self.assertIn('viewer.deck = {', html)
        self.assertIn("undo: ovizDeckUndo", html)
        self.assertIn("objects: {", html)
        self.assertIn("addShape: ovizDeckAddShape", html)
        self.assertIn("guides: {", html)
        self.assertIn("function ovizDeckRenderSelectionFrame()", html)
        self.assertIn('listLabel.textContent = "List";', html)
        self.assertIn('["bullet", "Bullets"]', html)
        self.assertIn('fontLabel.textContent = "Font";', html)
        self.assertIn("new RevealConstructor(ovizDeckRevealRootEl", html)
        self.assertIn("viewer.deck = {", html)
        self.assertIn("deck-present-start", html)
        self.assertIn("root.dataset.deckStateError = message;", html)
        self.assertIn('domain: "state"', html)
        self.assertIn("exportSceneSpec.deck = ovizDeckExportSpec", html)
        ...
        self.assertTrue(viz.fig_dict["animation"]["fade_opacity_by_birth_time_default"])
    ...
    def test_threejs_html_can_force_compressed_scene_spec_payload(self):
        ...
        self.assertIn("decodeOvizBase64PayloadChunks(payloadSource)", html)
        self.assertIn("payloadEl.remove();", html)
        self.assertIn("payloadSource.elements[chunkIndex] = null;", html)
        self.assertIn("const compressedBlob = new Blob(compressedChunks);", html)
        self.assertNotIn(
            'chunkEls.map((payloadEl) => payloadEl.textContent || "").join("")',
            html,
        )
    ...
    def test_threejs_renderer_serializes_actions(self):
        ...
        manual_camera_body = html.split(
            "function handleManualCameraInteractionStart()", 1
        )[1].split("function updateZoomAnchorFromControlsPan()", 1)[0]
        self.assertIn("if (cameraAutoOrbitEnabled)", manual_camera_body)
        self.assertIn("setCameraAutoOrbitEnabled(false)", manual_camera_body)
        self.assertNotIn("minimalModeEnabled && cameraAutoOrbitEnabled", manual_camera_body)
    ...
    def test_threejs_renderer_keeps_actions_in_minimal_mode(self):
        ...
        self.assertNotIn("function collectOvizArSnapshot", html)
        self.assertNotIn("const OVIZ_AR_MAX_POINTS", html)
        self.assertNotIn('<button class="oviz-three-mobile-ar"', html)
    ...
    def test_threejs_renderer_exports_mobile_mode_metadata_and_ui_hooks(self):
        ...
        self.assertNotIn("function collectOvizArSnapshot", html)
        self.assertNotIn("class OvizUSDZExporter", html)
        self.assertNotIn('rel="ar"', html)
        self.assertIn('height: 100dvh;', html)
        self.assertIn('env(safe-area-inset-bottom, 0px)', html)
        self.assertIn("flex-wrap: nowrap;", html)
        self.assertIn("width: min(480px, calc(100vw", html)
        self.assertIn("width: min(410px, calc(100vw", html)
        self.assertIn("width: calc(100% - 16px) !important;", html)
        self.assertIn("padding-inline: 8px !important;", html)
        self.assertIn("function startSkyViewTouchPinch", html)
        self.assertIn("function updateSkyViewTouchPinch", html)
        self.assertIn("function finishSkyViewTouchPinch", html)
        self.assertIn("const zoomFactor = skyViewPinchState.previousDistance / nextDistance;", html)
        self.assertIn("setCameraFovFromZoomFactor(zoomFactor)", html)
        self.assertIn("function handleCanvasTouchTap", html)
        self.assertIn("function showClusterInfoTooltipFromPointerEvent", html)
        self.assertIn('canvasPointerDownInfo.pointerType === "touch"', html)
        self.assertIn("handleCanvasTouchTap(event)", html)
        self.assertIn("oviz-three-fullscreen", html)
        self.assertIn("oviz-three-fullscreen-expand", html)
        self.assertIn("oviz-three-fullscreen-compress", html)
        self.assertIn("oviz-three-fullscreen-notice", html)
        self.assertIn("function ovizNativeFullscreenAvailable", html)
        self.assertIn("function ovizStandaloneDisplayMode", html)
        self.assertIn("navigator.standalone === true", html)
        self.assertIn('window.matchMedia("(display-mode: standalone)").matches', html)
        self.assertIn("function ovizMobileFullscreenFallbackAvailable", html)
        self.assertIn("function toggleOvizMobileFullscreenFallback", html)
        self.assertIn("root.dataset.browserFullscreen", html)
        self.assertIn("fullscreenButtonEl.disabled = !nativeFullscreenEnabled && !fallbackAvailable;", html)
        self.assertIn("iPhone Safari blocks true fullscreen; tap for compact view", html)
    ...
    def test_threejs_renderer_can_explicitly_enable_experimental_ar(self):
        ...
        fig = viz.make_plot(
            ...
            renderer="threejs",
            show=False,
            threejs_initial_state={"mobile_mode_enabled": True, "ar_enabled": True},
        )

        html = fig.to_html()

        self.assertTrue(viz.fig_dict["ar"]["enabled"])
        self.assertIn('data-ar-enabled="true"', html)
        self.assertIn('<button class="oviz-three-mobile-ar"', html)
        self.assertIn("mobileArButtonEl.addEventListener", html)
        self.assertIn("function collectOvizArSnapshot", html)
        self.assertIn("function ovizArPresentFrameIndex", html)
        self.assertIn("const OVIZ_AR_MAX_POINTS = 240;", html)
        self.assertIn("const OVIZ_AR_MAX_VOLUME_SAMPLES = 900;", html)
        self.assertIn("function ovizArCreateVolumeCloudTexture", html)
        self.assertIn("function buildOvizArSkyDomeScene", html)
        self.assertIn("class OvizUSDZExporter", html)
        self.assertIn('rel="ar"', html)
        self.assertIn("iPhone Safari blocks true fullscreen for HTML. Oviz entered compact view; Add to Home Screen to hide Safari bars.", html)
        self.assertIn("setZenMode(true);", html)
        self.assertIn("root.requestFullscreen", html)
        self.assertIn("root.webkitRequestFullscreen", html)
        self.assertIn("document.exitFullscreen", html)
    ...
    def test_chronos_mobile_runner_uses_full_resolution_mobile_assets(self):
        ...
        self.assertIn('GALACTIC_PLANE_IMAGE_PATH = HOME_DIR / "Downloads" / "Top-down_view_of_the_Milky_Way.jpg"', source)
        self.assertIn("galaxy_image_path = GALACTIC_PLANE_IMAGE_PATH", source)
        self.assertIn("MAIN_FIGURE_DUST_OPACITY = 1.0", source)
        self.assertIn("MOBILE_SAFE_TIMESTEP_MYR = 1", source)
        self.assertIn("MAIN_FIGURE_DUST_MAX_RESOLUTION", source)
        self.assertIn("MAIN_FIGURE_DUST_SAMPLES", source)
        self.assertIn("\"max_resolution\",\n        MAIN_FIGURE_DUST_MAX_RESOLUTION", source)
        self.assertIn("\"samples\",\n        MAIN_FIGURE_DUST_SAMPLES", source)
        self.assertIn("'mobile_defer_volumes': False", source)
        self.assertIn('"volumes=[edenhofer_volume, *mccallum_ne_volumes, "', source)
        self.assertIn('"*vergely_dust_volumes, *supernova_volumes]"', source)
        self.assertNotIn("mobile_safe_galaxy_image_path", source)
        self.assertNotIn("MOBILE_SAFE_GALAXY_IMAGE_MAX_PX", source)
        self.assertNotIn("MOBILE_SAFE_DUST_MAX_RESOLUTION", source)
        self.assertNotIn("edenhofer-dust-mobile", source)
        self.assertNotIn("edenhofer-dust-desktop", source)
        self.assertNotIn("edenhofer_volumes", source)
    ...
    def test_threejs_galactic_coordinates_are_labelled_and_time_independent(self):
        ...
        )[1].split("function presentDayOnlyTimelineOpacity()", 1)[0]
        present_day_opacity_body = html.split(
        ...
        milky_way_opacity_body = html.split(
            "function milkyWayTimelineOpacity()", 1
        ...
        self.assertIn("return presentDayOnlyTimelineOpacity();", time_opacity_body)
        self.assertIn("Math.abs(timeMyr)", present_day_opacity_body)
        self.assertIn(
            "1.0 - smoothstep01(clampRange(Math.abs(timeMyr), 0.0, 1.0))",
            present_day_opacity_body,
        )
        self.assertIn("return presentDayOnlyTimelineOpacity();", grid_opacity_body)
        self.assertIn("return presentDayOnlyTimelineOpacity();", milky_way_opacity_body)
    ...
    def test_threejs_renderer_can_enable_aladin_sky_dome_without_local_image(self):
        ...
        self.assertIn("{ survey: initialAladinFrameSurvey() }", html)
    ...
    def test_threejs_renderer_can_use_live_aladin_sky_dome_background(self):
        ...
        self.assertIn("successCallback: () => settleSurveyReady({ ready: true })", html)
        self.assertIn("errorCallback: () => settleSurveyReady({ ready: false, failed: true })", html)
    ...
    def test_threejs_renderer_exposes_sky_aperture_for_live_aladin_backgrounds(self):
        ...
        self.assertIn("oviz-three-sky-aperture-toggle-plus", html)
        self.assertIn("oviz-three-sky-apertures", html)
        ...
        self.assertIn("oviz-three-sky-aperture-hit-shield", html)
        self.assertIn("oviz-three-sky-aperture-outline", html)
        self.assertIn("oviz-three-sky-aperture-quad", html)
        self.assertIn("oviz-three-sky-aperture-close", html)
        self.assertIn("oviz-three-sky-aperture-promote", html)
        self.assertIn("oviz-three-sky-aperture-band-picker", html)
        self.assertIn("oviz-three-sky-aperture-spectrum-band", html)
        self.assertIn("oviz-three-sky-aperture-spectrum-band-label", html)
        self.assertNotIn("oviz-three-sky-aperture-spectrum-slider oviz-three-slider", html)
        self.assertIn("H-alpha", html)
        self.assertIn("Near IR", html)
        self.assertIn("Mid IR", html)
        self.assertIn("AKARI Far IR", html)
        self.assertIn("Dust", html)
        self.assertIn("skyApertureMaxActive = 6", html)
        self.assertIn("let skyApertureInstances = []", html)
        ...
        self.assertIn("function renderSkyApertureBandButtons()", html)
        self.assertIn("function setSkyApertureBandKey(bandKey)", html)
        self.assertIn("buttonEl.dataset.active", html)
        self.assertIn("buttonEl.disabled = Boolean(band.disabled)", html)
        self.assertIn("function createSkyApertureInstance(savedState = null)", html)
        self.assertIn("function closeSkyApertureInstance(instance)", html)
        self.assertIn("function addSkyAperture(savedState = null)", html)
        self.assertIn("targetEl.addEventListener(\"contextmenu\"", html)
        self.assertIn("pointerMode = event.button === 2 ? \"opacity\" : undefined", html)
        self.assertIn("skyApertureState.opacity = clampSkyApertureOpacity", html)
        self.assertIn("touch-action: none;", html)
        self.assertIn("function skyApertureControlsAvailable(options = {})", html)
        ...
        self.assertIn("function postSkyApertureViewToFrames(timestampMs = 0.0, options = {})", html)
        self.assertIn("window.cancelAnimationFrame(skyApertureViewPostFrame);", html)
        ...
        self.assertIn("const frameEl = skyApertureFrameAEl", html)
        self.assertIn("skyAperturePresetFrameEls = [frameEl];", html)
        self.assertNotIn('frameEl = document.createElement("iframe");', html)
        self.assertIn("oviz-three-sky-aperture-frame-stack", html)
        self.assertNotIn("oviz-three-sky-aperture-frame-preset", html)
        self.assertNotIn("frameEls.forEach((frameEl) =>", html)
        self.assertIn("clipEl.style.opacity = String(", html)
        self.assertIn("function postSkyApertureLayerStateToFrame(", html)
        self.assertIn("type: \"oviz-sky-layer-state\"", html)
        self.assertIn("type: \"oviz-sky-aperture-layer-state\"", html)
        self.assertIn("type: \"oviz-sky-aperture-clip\"", html)
        self.assertIn("function applySkyApertureLayerState(data)", html)
        self.assertIn("function applySkyApertureClip(data)", html)
        self.assertIn('data-oviz-aperture-layer="true"', html)
        self.assertIn("scheduleSkyLayerCanvasTagging(layerName, beforeCanvases, \"aperture\")", html)
        self.assertIn("clearSkyLayerCanvasScope(\"aperture\")", html)
        self.assertNotIn("canvas:not(:first-of-type)", html)
        self.assertIn("function skyApertureUsesBaseFrameStack()", html)
        self.assertIn("function skyApertureNeedsFallbackFrame()", html)
        self.assertIn("function skyApertureNeedsFallbackFrame() {\n        return true;\n      }", html)
        self.assertNotIn("visibleMainLayerCount <= 1", html)
        self.assertNotIn("!options.forceFallback && !skyApertureNeedsFallbackFrame()", html)
        self.assertIn("if (!skyApertureNeedsFallbackFrame()) {", html)
        self.assertNotIn("const needsFallbackFrame = skyApertureNeedsFallbackFrame();", html)
        self.assertIn("postSkyApertureLayerStateToFrame(blend)", html)
        ...
        self.assertIn('data-startup-ready="false"', html)
        self.assertIn('[data-startup-ready="false"] > :not(.oviz-three-startup-status)', html)
        self.assertIn("async function waitForInitialSkyLayers(options = {})", html)
        self.assertIn("const expectedCount = skyLayersForCurrentGroup().length;", html)
        self.assertIn("function postSkyLayerStackReady(", html)
        self.assertIn('type: "oviz-aladin-sky-layers-ready"', html)
        self.assertIn('type: "oviz-sky-layer-preload"', html)
        self.assertIn("function preloadSkyLayerSurveys(data)", html)
        self.assertIn("scheduleRemainingSkyLayerMetadataPreload();", html)
        self.assertIn("waitForInitialSkyLayers({ timeoutMs: 30000.0 }).then(", html)
        self.assertNotIn("await waitForInitialSkyLayers({ timeoutMs: 30000.0 })", html)
        self.assertIn('root.dataset.startupReady = "true";', html)
        ...
        self.assertNotIn("if (skyAperturePointerState) {\n          return;\n        }\n        if (!skyApertureNeedsFallbackFrame())", html)
        self.assertNotIn("const controlsReady = skyApertureControlsAvailable();", html)
        self.assertIn("framesTotal: skyApertureDebugFramesTotal()", html)
        self.assertIn("framesReady: skyApertureDebugFramesReady()", html)
        ...
        self.assertIn("captureSkyApertureStates()", html)
        ...
        self.assertIn("band_key: String(skyApertureState.bandKey || \"\")", html)
        self.assertIn("opacity: clampSkyApertureOpacity(skyApertureState.opacity)", html)
        self.assertIn("savedGlobalControls.sky_apertures", html)
        self.assertIn("savedGlobalControls.sky_aperture", html)
        self.assertIn("sky_apertures: typeof captureSkyApertureStates === \"function\" ? captureSkyApertureStates() : []", html)
    ...
    def test_threejs_renderer_restores_saved_sky_aperture_state(self):
        ...
        self.assertIn("savedGlobalControls.sky_apertures", html)
        self.assertIn("savedGlobalControls.sky_aperture", html)
        self.assertIn("initialState.sky_apertures || initialState.sky_aperture", html)
        self.assertIn("function restoreSkyApertureActiveState(savedState)", html)
    ...
    def test_threejs_renderer_can_use_native_hips_sky_dome_background(self):
        ...
        self.assertIn("oviz-three-sky-layer-list", html)
        self.assertIn("oviz-three-sky-layer-summary", html)
        self.assertNotIn("<span>Sky Backgrounds</span>", html)
        ...
        self.assertIn('class="oviz-three-group-dropdown oviz-three-sky-group-dropdown"', html)
        self.assertIn("oviz-three-sky-controls-toggle oviz-three-group-trigger oviz-three-sky-group-trigger", html)
        self.assertIn("fallbackSkyLayerGroupDefinitions", html)
        self.assertIn('key: "all",\n          label: "All"', html)
        self.assertIn('label: "All-Sky"', html)
        self.assertIn('"P/Mellinger/color",\n            "P/DSS2/color",\n            "P/PLANCK/R2/HFI/color"', html)
        self.assertIn('label: "Optical Surveys"', html)
        self.assertIn('label: "Infrared & UV"', html)
        self.assertIn("function skyLayersForCurrentGroup()", html)
        self.assertIn("function skyLayerIsInCurrentGroup(layer)", html)
        self.assertIn('group_key: layer.groupKey || "",', html)
        self.assertIn("const destinationGroupKey = currentSkyLayerGroupKey;", html)
        self.assertIn('groupKey: destinationGroupKey !== "all" ? destinationGroupKey : "",', html)
        self.assertIn("existing.groupKey = destinationGroupKey;", html)
        self.assertNotIn("currentSkyLayerGroupKey = skyLayerGroupKeyForLayer(layer);", html)
        self.assertIn('activeGroup.key === "all"', html)
        self.assertIn("const currentGroupKeys = new Set(skyLayersForCurrentGroup()", html)
        self.assertIn(".filter((layer) => currentGroupKeys.has(layer.key))", html)
        self.assertIn("applySkyLayerState({ forceTiles: true });", html)
        self.assertIn("function renderSkyLayerGroupDropdown()", html)
        self.assertIn("moveActiveSkyLayerWithinCurrentGroup", html)
        self.assertNotIn("Show sky dome", html)
        self.assertNotIn("Keep sky visible", html)
