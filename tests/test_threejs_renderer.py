...
class ThreeJSRendererTests(unittest.TestCase):
    ...
    def test_make_plot_can_return_threejs_html_wrapper(self):
        ...
        self.assertIn("font-size: 19.5px !important;", html)
        ...
        self.assertIn(") ? ovizDeckPrevious() : ovizStatesPresentationPrevious();", html)
        self.assertIn(") ? ovizDeckNext() : ovizStatesPresentationNext();", html)
    ...
    def test_chronos_mobile_runner_uses_full_resolution_mobile_assets(self):
        ...
        self.assertIn("volumes=[edenhofer_volume, *supernova_volumes]", source)
